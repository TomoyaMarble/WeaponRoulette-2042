function ramdom_up() {
    const weapons_M_2042 = ["PBX-45", "PP-29", "MP9", "K30", "AC9", "M5A3", "AM40", "AK-24", "SFAR-M GL", "AC-42", "RM68", "GEW-46", "VHX-D3", "LCMG", "アバンシーズ", "PKP-BP", "RPT-31", "DM7", "SVK", "VCAR", "BSV-M", "G428", "SWS-10", "DXR-1", "NTW-50", "XCE Bar", "MCS-880", "GVT 45-70", "12M オート", "ゴーストメーカーR10", "Rorsch Mk-4", "NVK-S22"];
    ...
    const weapons_S_2042 = ["G57", "MP28", "M44", "PF51", "NVK-P125", "Super 500", "L9CZ", "BFP.50"];
    ...
    const gadgets_S = ["弾薬箱", "医療箱", "スモークランチャー", "M18 クレイモア" , "弾薬袋", "医療袋"];
    const gadgets_R = ["T-UGS", "トレーサーダーツガン", "C5爆薬", "M18 クレイモア", "近接センサー", "SOFLAM"];
